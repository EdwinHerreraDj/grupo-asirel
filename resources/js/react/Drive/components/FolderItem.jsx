// resources/js/react/Drive/components/FolderItem.jsx
...
export default function FolderItem({ folder, onClick, onDelete, onRename }) {
    ...
    const { cutSingleFolder } = useClipboard(); // ✅ Cambiado de cutItem a cutSingleFolder
    ...
    const handleCut = () => {
        const result = cutSingleFolder(folder); // ✅ Usar cutSingleFolder
        setShowMenu(false);
