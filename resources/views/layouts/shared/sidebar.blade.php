        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="{{ route('empresa.index') }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_building_4_line"></i></span>
            ...
            <li class="menu-item">
                <a href="{{ route('unidad') }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_greatwall_line"></i></span>
            ...
            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin')
                ...
                <li class="menu-item">
                    <a href="{{ route('obras.create') }}" data-fc-type="collapse" class="menu-link">
