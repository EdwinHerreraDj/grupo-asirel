    ...
    <div class="card p-6">
        ...
        <div class="flex justify-between">
            <div>
                ...
                <h1 class="mt-2 text-lg md:text-xl font-semibold text-primary dark:text-white">Geocaminos.</h1>
            </div>
            <!-- Col -->
        ...
        <div class="mt-8 sm:mt-12">
            ...
            <div class="mt-2">
                <p class="block text-sm font-medium text-gray-800 dark:text-gray-200">info@geocaminos.es</p>
                <p class="block text-sm font-medium text-gray-800 dark:text-gray-200">+1 (062) 109-9222</p>
            </div>
        </div>

        <div class="flex items-center justify-between">
            <p class="mt-5 text-sm text-gray-500">© 2025 Geocaminos.</p>
