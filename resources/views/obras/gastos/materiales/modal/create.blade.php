    ...
    <div
        ...
        <div class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700">
            <h3 class="font-medium text-gray-800 dark:text-white text-lg">
                Gasto de Materiales obra {{ $obra->nombre }}
            </h3>
        ...
        <div class="px-4 py-8 overflow-y-auto">
            <div>
                <form id="form" action="{{ route('materiales.store') }}" method="POST" enctype="multipart/form-data"
                    onsubmit="return verificarEnvio(event)">
                    @csrf
                    <input type="hidden" name="obra_id" value="{{ $obra->id }}">

                    <label for="nombre" class="font-medium text-gray-700">Material:</label>
                    <select
                    ...
                    <div id="descripcion-container">
                        <label for="descripcion" class="font-medium text-gray-700">Especifique el material:</label>
                        <input
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring focus:ring-blue-200 focus:border-blue-400 mb-5"
                    ...
                    <div class="relative mb-5">
                        <input
                            class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none focus:ring focus:ring-blue-200 focus:border-blue-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-blue-600 file:text-white hover:file:bg-blue-700 transition-all"
                            type="file" name="archivo_factura" id="archivo_factura"
                            accept="image/*,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/x-rar-compressed,application/zip">
                    </div>
